...
function buildMetricForDate({
  ...
  return {
    ...
    advertising,
    ozonCommission,
    partnerServices: round2(financeFacts.partnerServices),
    fboServices: round2(financeFacts.fboServices),
    partnerServicesExport: round2(Math.abs(financeFacts.partnerServices)),
    fboServicesExport: round2(Math.abs(financeFacts.fboServices)),
    cogsTotal,
    logisticsToMp,
    logisticsActual,
    partnerServices,
